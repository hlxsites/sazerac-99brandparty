...
export default async function decorate(block) {
  if (block.querySelector('p') == null) {
    ...
    // add all products as from index
    ...
    partypacks.innerHTML = '<a href="/party-packs" title="99 party packs"><h3>99 Party Packs</h3></a><p class="button-container"><a href="/party-packs" title="99 spirits collection" class="button secondary">More</a></p>';
